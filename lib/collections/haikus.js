...
Haikus.attachSchema( new SimpleSchema({
  ...
  textColor:        { type: String, allowedValues: ['white', 'black'] },
  textAlign:        { type: String, allowedValues: ['left', 'center', 'right'] },
  textValign:       { type: String, allowedValues: ['top', 'center', 'bottom'] },
  backgroundAlign:  { type: String, allowedValues: ['left', 'center', 'right'] },
  backgroundValign: { type: String, allowedValues: ['top', 'center', 'bottom'] },
  backgroundImage:  { type: String },
  overlayColor:     { type: String, allowedValues: ['white', 'black'] },
  overlayDirection: { type: String, allowedValues: [
    'top', 'left', 'center', 'right', 'bottom']
  },
  showBackground:   { type: Boolean, defaultValue: false },
  ...
  // The user posting OR sharing the Haiku
  userId:           { type: String },
